...
class DeltaLoaderSpec extends SparkSpec with BeforeAndAfterAll {
  ...
  it should "replace partition statically" in {
    ...
    DeltaLoader.overwritePartition(testtableoverwite, "default", tableName, updates, List("ingested_on"), "delta", Map("replaceWhere" -> "ingested_on = '1900-01-02'"))
