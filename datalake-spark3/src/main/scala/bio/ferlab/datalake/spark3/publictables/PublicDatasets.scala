...
case class PublicDatasets(alias: String, tableDatabase: Option[String], viewDatabase: Option[String]) extends BaseDatasets {
  val sources: List[DatasetConf] = List(
          ...
          DatasetConf("normalized_gnomad_cnv_v4"           , alias, "/public/gnomad_joint_v4"                      , DELTA, OverWrite , partitionby = List("chromosome"), table = table("gnomad_cnv_v4")            , view = view("gnomad_cnv_v4")),
