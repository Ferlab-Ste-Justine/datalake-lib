...
case class PublicDatasets(alias: String, tableDatabase: Option[String], viewDatabase: Option[String]){
  ...
  val sources: List[DatasetConf] = List(
          ...
          DatasetConf("raw_ensembl_canonical", alias, "/raw/landing/ensembl/Homo_sapiens.GRCh38.108.canonical.tsv.gz", CSV, OverWrite, readoptions = Map("header" -> "false", "sep" -> "\t")),
          DatasetConf("raw_ensembl_entrez", alias, "/raw/landing/ensembl/Homo_sapiens.GRCh38.108.entrez.tsv.gz", CSV, OverWrite, readoptions = Map("header" -> "true", "sep" -> "\t")),
          DatasetConf("raw_ensembl_refseq", alias, "/raw/landing/ensembl/Homo_sapiens.GRCh38.108.refseq.tsv.gz", CSV, OverWrite, readoptions = Map("header" -> "true", "sep" -> "\t")),
          DatasetConf("raw_ensembl_uniprot", alias, "/raw/landing/ensembl/Homo_sapiens.GRCh38.108.uniprot.tsv.gz", CSV, OverWrite, readoptions = Map("header" -> "true", "sep" -> "\t")),
          DatasetConf("raw_ensembl_ena", alias, "/raw/landing/ensembl/Homo_sapiens.GRCh38.108.ena.tsv.gz", CSV, OverWrite, readoptions = Map("header" -> "true", "sep" -> "\t")),
          //public
