...
class SpliceAi(variantType: String)(implicit conf: Configuration) extends ETLP {
  ...
  override def transformSingle(data: Map[String, DataFrame],
    ...
    df
      ...
      .withColumn("ds_ag", $"spliceai"(2))
      .withColumn("ds_al", $"spliceai"(3))
      .withColumn("ds_dg", $"spliceai"(4))
      .withColumn("ds_dl", $"spliceai"(5))
      .withColumn("dp_ag", $"spliceai"(6))
      .withColumn("dp_al", $"spliceai"(7))
      .withColumn("dp_dg", $"spliceai"(8))
      .withColumn("dp_dl", $"spliceai"(9))
      .drop("spliceai")
  }
